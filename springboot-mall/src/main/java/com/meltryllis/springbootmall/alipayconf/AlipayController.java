...
import com.meltryllis.springbootmall.mapper.OrderMapper;
...
public class AlipayController {
    ...
    public String goAlipay(HttpServletRequest request, HttpServletRequest response,
                           String pName, Integer pid, String price, Integer num, HttpSession session) throws Exception {

        float totalPrice = Float.parseFloat(price) * num;
        ...
        order.setGenerationTime(new Date());
